<template>
  <div class="relative">
    <flat-pickr class="form-input pl-9 text-slate-500 hover:text-slate-600 font-medium focus:border-slate-300 w-60" :config="config" v-model="date" placeholder="Select a date"></flat-pickr>
