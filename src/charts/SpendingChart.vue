...
// Import utilities
import {CHART_FORMAT_DATE, formatCurrency, formatDate, tailwindConfig} from '../utils/Utils'
          ...
          plugins: {
            ...
            tooltip: {
              callbacks: {
                ...
                label: (context) => [`${formatDate(context.label,CHART_FORMAT_DATE)}`,`${formatCurrency(context.parsed.y)}`],
              },
            },
          },
          interaction: {
